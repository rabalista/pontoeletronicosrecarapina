...
new_logic = """        if target_user_id:
            ...
            import os, calendar
            try:
                template_path = os.path.join(app.root_path, "PADRAO 8 HS.xlsx")
                ...
                if m_name in wb.sheetnames:
                    ...
                    for d_idx in range(1, num_days + 1):
                        ...
                        if has_atestado or has_abono:
                            ...
                            # Atestado overrides everything and we set special format
...
if idx1 != -1 and idx2 != -1:
    old_target = text[idx1:idx2]
    # Keep the wb = openpyxl.Workbook() initialization above the if condition intact
    # We replace the entire if block
    new_text = text[:idx1] + new_logic + '\n' + text[idx2:]
    with codecs.open('app.py', 'w', 'utf-8') as f:
        f.write(new_text)
    print("app.py updated successfully!")
else:
    print("Could not find the target block indices in app.py")
